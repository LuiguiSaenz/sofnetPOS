...
async function loginx(username, password) {
    ...
    return fetch(`https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/nupy-cfbnr/service/restaurant/incoming_webhook/pos_login?email=${username}&password=${password}`)
    .then(res => res.json())
    .then(async res => {
